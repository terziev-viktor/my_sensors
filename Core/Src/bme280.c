...
void TrimRead(void)
{
	...
	assert(HAL_I2C_Mem_Read(BME280_I2C, BME280_ADDRESS, 0xE1, 1, (uint8_t *)trimdata+25, 7, HAL_MAX_DELAY) == HAL_OK);
...
int BMEReadRaw(void)
{
	...
	const HAL_StatusTypeDef status = HAL_I2C_Mem_Read(&hi2c1, BME280_ADDRESS, ID_REG, 1, &chipID, 1, 2000);
